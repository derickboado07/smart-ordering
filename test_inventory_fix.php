...
// Find a paid order that hasn't been completed yet
$result = $conn->query("SELECT id FROM orders WHERE payment_status = 'paid' AND (order_status IS NULL OR order_status != 'completed') LIMIT 1");
